...
export default function Footer() {
  const socialLinks = [
    { href: 'https://www.facebook.com/geckobasket/', icon: facebookIcon, label: 'Facebook' },
    ...
    <footer className="bg-[#f0f2f3] text-gray-700 font-inter">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
        ...
        <nav aria-label="Shop" className="flex flex-col space-y-4 text-sm text-gray-600">
          <h4 className="text-gray-900 font-medium text-base">Shop</h4>
        ...
        <nav aria-label="Customer Care" className="flex flex-col space-y-4 text-sm text-gray-600">
          <h4 className="text-gray-900 font-medium text-base">Customer Care</h4>
          <ul className="space-y-2">
        ...
        <address className="not-italic flex flex-col space-y-4 text-sm text-gray-600">
          <h4 className="text-gray-900 font-medium text-base">Contact</h4>
          ...
          <p className="flex items-center space-x-3">
            ...
            <a href="mailto:info@geckoworksnepal.com" className="hover:text-green-600 transition" aria-label="Email Gecko Basket">
